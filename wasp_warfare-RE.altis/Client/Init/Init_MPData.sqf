...
["Init_MPData.sqf", "Server Available"] call Fun_AddToLog;
...
["Init_MPData.sqf", "Server Data Request Sent, wait Answer"] call Fun_AddToLog;
...
["Init_MPData.sqf", "Data Received"] call Fun_AddToLog;

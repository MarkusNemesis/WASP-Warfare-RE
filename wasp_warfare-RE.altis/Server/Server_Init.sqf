...
["Server_Init.sqf", "Respawn Vehicles near MHQ"] spawn Fun_AddToLog;
[] spawn Compile preprocessFileLineNumbers "Server\FSM\Server_Loop_Debug.sqf";
["Server_Init.sqf", "Debug loop - Spawn"] spawn Fun_AddToLog;
["Server_Init.sqf", "Main Server loop - Spawn"] spawn Fun_AddToLog;
[] spawn Compile preprocessFileLineNumbers "Server\FSM\Server_Loop.sqf";
["Server_Init.sqf", "Server loop"] spawn Fun_AddToLog;
[] spawn{
 sleep 40;
...
createDialog 'WFVote'}], objNull] call Send_Run;
  ...
  ["Server_Init.sqf", "Start vote for booth team"] spawn Fun_AddToLog;

};

[] call Compile preprocessFileLineNumbers "AI\AI_Init.sqf";
Public_ServerInit = true;
["Server_Init.sqf", "Server init Complete"] spawn Fun_AddToLog;
